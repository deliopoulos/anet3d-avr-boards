#
#  Anet3D Arduino IDE Module makefile.
#
PACKAGE_NAME := anet3d
...
EXTRA_FILES := boards.txt

BOOTLOADERS := optiboot-anet/*.hex
...
archive :
	...
	@echo "This is an Anet3D AVR Boards version ${PACKAGE_VERSION} Release" > ${PACKAGE_FOLDER}/README.TXT
	@echo >> ${PACKAGE_FOLDER}/README.TXT
	@echo "For Source code see https://github.com/deliopoulos/anet3d-avr-boards" >> ${PACKAGE_FOLDER}/README.TXT
